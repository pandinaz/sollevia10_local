...
const getImg = (id: string) => `https://images.unsplash.com/${id}?q=80&w=800&auto=format&fit=crop`;
...
export const MODULES: Module[] = [
  // --- Category 1: Pain Understanding ---
  {
    ...
    thumbnailUrl: getImg('photo-1518531933037-91b2f5f229cc'), // Plant growing (Growth/Life)
    duration: '4 min',
    ...
    steps: [
      {
        ...
        imageUrl: getImg('photo-1518531933037-91b2f5f229cc')
      },
      {
  ...
  },
  {
    ...
    thumbnailUrl: getImg('photo-1494548162494-384bba4ab999'), // Sunrise over hills (Interconnected layers)
    duration: '5 min',
    ...
    steps: [
      {
        ...
        imageUrl: getImg('photo-1494548162494-384bba4ab999')
      },
      {
  ...
  // --- Category 2: Pain Triggers ---
  {
    ...
    thumbnailUrl: getImg('photo-1515694346937-94d85e41e6f0'), // Rain on glass (Mood/Tension)
    duration: '5 min',
    ...
    steps: [
       {
        ...
        imageUrl: getImg('photo-1515694346937-94d85e41e6f0')
      },
      {
  ...
  },
  {
    ...
    thumbnailUrl: getImg('photo-1505118380757-91f5f5632de0'), // Stormy Ocean (Inner turmoil)
    duration: '6 min',
    ...
    steps: [
        {
            ...
            imageUrl: getImg('photo-1505118380757-91f5f5632de0')
        },
        {
  ...
  },
  {
    ...
    thumbnailUrl: getImg('photo-1534447677768-be436bb09401'), // Stormy forest/Mist
    duration: '20 min',
    ...
    subModules: [
      {
        ...
        step: {
            ...
            imageUrl: getImg('photo-1534447677768-be436bb09401')
        }
      },
      {
        id: 'sm-cat',
...
Decatastrophizing needs practice, feel free to repeat this exercise as many times you like.`,
  ...
  },
  {
    ...
    thumbnailUrl: getImg('photo-1441974231531-c6227db76b6e'), // Sunlight on Forest Path
    duration: '6 min',
    ...
    steps: [
      {
        ...
        imageUrl: getImg('photo-1441974231531-c6227db76b6e'),
      },
      {
  ...
  // --- Category 3: Coping Strategies ---
  {
    ...
    thumbnailUrl: getImg('photo-1465146344425-f00d5f5c8f07'), // Deep Forest/Greenery
    duration: '30 min',
...
For relaxation to be most effective, regular and long-term application is vital. Consistency helps your brain "unlearn" its hypersensitivity and can actually reduce pain signals over time. It is helpful to practice in a quiet environment and build these exercises into your daily routine, such as practicing at the same time each day to make it a habit.`,
                imageUrl: getImg('photo-1465146344425-f00d5f5c8f07')
            }
        },
        {
